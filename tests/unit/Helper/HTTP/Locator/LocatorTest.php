...
class LocatorTest extends \Codeception\Test\Unit
{
    ...
    /**
     * @group locator
     * @group locator-invoice-item-edit-multiple
     */
    public function testInvoiceItemEditMultiple(){
    ...
    public function testPatternCreate(){
        ...
        $pattren = Locator::createPattern($route);


        $this->assertSame('#^/invoice/([0-9]*)$#', $pattren);
